...
import "../roommate_steps/roommate-steps.scss";
function FriendSteps() {
    return (
        <section className="roommate-steps wavy-bg">
            <h2 className="heading slide-in-rest">
                Step by step Process On How To Use Studentrealestate to Get Friend(s)
            </h2>
